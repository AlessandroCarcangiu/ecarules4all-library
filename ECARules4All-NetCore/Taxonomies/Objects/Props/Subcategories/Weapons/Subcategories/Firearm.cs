    ...
    public class Firearm : MonoBehaviour
    {
        ...
        public void Recharges(int charge)
        {
            if (charge > 0)
            {
                ...
                {
                    particleRechargePrefab =
                        Instantiate(Resources.Load("Particles/Particle_Recharges"), transform) as GameObject;
            ...
            if (charge > 0)
            {
                ...
                if (bulletPrefab != null)
                {
                    ...
                    bulletInstance.GetComponent<Rigidbody>()
                        .AddForce(transform.forward * bulletPrefab.GetComponent<Bullet>().speed);
                }

                if (particleFire == null)
                {
                    particleFirePrefab =
                        Instantiate(Resources.Load("Particles/Particle_Fire"), transform) as GameObject;
