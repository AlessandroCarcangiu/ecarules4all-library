...
namespace ECARules4AllPack.Utils
{
    public class ECARules4AllOperations
    {
        ...
        public static Dictionary<ECARules4AllType, string[]> supportedOperations =
            new Dictionary<ECARules4AllType, string[]>
            {
        ...
        public static Dictionary<ECARules4AllType, bool> supportsMathematicalConditionChecks =
            new Dictionary<ECARules4AllType, bool>
            {
